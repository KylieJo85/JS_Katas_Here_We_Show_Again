//* Ashley, Joeseph, Arjun, Colin, Josh, Tony and myself were contributors to this katas assessment//*


//*Need to label individual Kata with heading followed by the solution.//*
...
for(let counter1 = 0; counter1 <= 20; counter1 += 2) {
    const newDiv = document.createElement("div")
...
for(let counter1 = 100; counter1 >=1; counter1 -= 5) {
    const newDiv = document.createElement("div")
...
for(let counter1 = 10; counter1 >= 1; counter1 -= 1) {
  let counterSquare2=counter1*counter1
    const newDiv = document.createElement("div")
    solution10.append(newDiv)
    newDiv.append(counterSquare2)
  }
